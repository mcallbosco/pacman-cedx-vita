...
void glColorMask(GLboolean red, GLboolean green, GLboolean blue, GLboolean alpha) {
	...
	if (_vgl_enqueue_list_func(glColorMask, DLIST_FUNC_U8_U8_U8_U8, red, green, blue, alpha))
		return;
#endif
#ifdef VITA3K_COLOR_MASK_WORKAROUND
	// Vita3K's Vulkan renderer doesn't implement GXM color write masks
	// and deadlocks during async shader compilation with partial masks.
	// Force all channels writable.
